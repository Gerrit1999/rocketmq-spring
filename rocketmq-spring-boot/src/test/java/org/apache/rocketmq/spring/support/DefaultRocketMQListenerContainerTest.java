...
class DefaultRocketMQListenerContainerTest {
    @Test
    void testGetMessageType() throws Exception {
        ...
        listenerContainer.setRocketMQListener((RocketMQListener<String>) message -> {
        });
        Class result = (Class) getMessageType.invoke(listenerContainer);
        assertThat(result.getName().equals(String.class.getName()));

        //support message
        listenerContainer.setRocketMQListener((RocketMQListener<Message>) message -> {
        });
        result = (Class) getMessageType.invoke(listenerContainer);
        assertThat(result.getName().equals(Message.class.getName()));

        listenerContainer.setRocketMQListener((RocketMQListener<MessageExt>) message -> {
        });
        result = (Class) getMessageType.invoke(listenerContainer);
        assertThat(result.getName().equals(MessageExt.class.getName()));


        listenerContainer.setRocketMQReplyListener((RocketMQReplyListener<MessageExt, String>) message -> "test");
        result = (Class) getMessageType.invoke(listenerContainer);
        assertThat(result.getName().equals(MessageExt.class.getName()));

        listenerContainer.setRocketMQReplyListener((RocketMQReplyListener<String, String>) message -> "test");
        result = (Class) getMessageType.invoke(listenerContainer);
        assertThat(result.getName().equals(String.class.getName()));
    }

    @Test
    void testDoConvertMessage() throws Exception {
        DefaultRocketMQListenerContainer listenerContainer = new DefaultRocketMQListenerContainer();
        ...
        listenerContainer.setRocketMQListener((RocketMQListener<User>) message1 -> {
        });

        listenerContainer.setRocketMQListener((RocketMQListener<User>) message12 -> {
        });
    }

    @Test
    void testGenericMessageType() throws Exception {
        DefaultRocketMQListenerContainer listenerContainer = new DefaultRocketMQListenerContainer();
        ...
        listenerContainer.setRocketMQListener((RocketMQListener<ArrayList<Date>>) message -> {
        ...
        listenerContainer.setRocketMQReplyListener((RocketMQReplyListener<ArrayList<Date>, String>) message -> "test");
    ...
    @Test
    void testSetRocketMQMessageListener() {
